...
"firstParagraph":"Dear patient, this information sheet is used to prepare for the informational discussion. Please read it carefully before the interview and carefully fill out the questionnaire.",
"treatmentoptions":"The treatment options: (Please select)",
"dasFadenlifting":"The thread lifting",
"dasFadenliftingDescription":"The principle of thread lifting consists in tightening tissue and lifting the sunken soft tissue again. The thread lifting can reduce strong wrinkles and lowered fat tissue can be raised again. The threads should bring about a collagen synthesis that stabilizes the tightening and develop a permanent holding effect due to their barbed surface texture.",
"botulinumtoxin":"Botulinum toxin A",
"botulinumtoxinDescription":"These agents inhibit the transmission of nerve impulses that trigger the drawing together of the muscles and thus contribute to the formation of mimic wrinkles. Depending on the dosage, the movement is inhibited or only severely restricted. However, since only a part of the facial muscles is affected, there is no mask-like face. The muscle tension in the treated areas subsides, which leads to significant relaxation of the skin and a reduction in wrinkles in the following days. The other facial muscles are not affected. Botulinum toxin A are particularly suitable for avoiding forehead lines, frown lines and crow's lips. In the case of certain pre-existing conditions (e.g. congenital muscle weakness), the injection cannot be given.",
"hyaluronsaure":"Hyaluronic acid",
"hyaluronsaureDescription":"The tissue filler must be injected exactly into the skin layer in which tissue loss has led to the formation of wrinkles. It may be necessary to inject directly into the individual skin layers (interdermal) or under the skin (subcutaneous). In some cases, a local anesthetic is used to avoid pain, but in most cases it can be dispensed with. Some tissue fillers are massaged into the skin after the injection in order to achieve an even result.",
"pRP":"PRP",
"prpDescription":"If platelet-rich plasma is used for tissue injection, some blood will first be taken from your arm vein. The blood is then further processed using a special procedure to separate the red blood cells (centrifugation). The thick blood plasma that remains is used directly for injection.",
"kostenubernahme":"Assumption of costs:",
"kostenubernahmeDescription":"The health insurance company does not cover the costs of these treatments and any complications that may require treatment.",
"risikenMogliche":"Risks and possible complications:",
"risikenMoglicheDescription":"Despite all the care, it can lead to -u.U. There are also life-threatening complications that require further treatment / operations. Pre-existing illnesses and individual peculiarities can significantly influence the frequency of complications.",
"risikenFirst":"Immediately after the injection, a small bruise may form at the injection site, which will subside after a few days, rarely after 2-3 weeks. Discoloration of the skin caused by bruises can in exceptional cases be visible for months.",
"risikenSecondnd":"If the substance is distributed in the tissue, the upper eyelid or brow may temporarily hang. When treating crow's feet, distribution of the substance around the eyes may cause temporary visual disturbances. These symptoms disappear again within a few weeks. (only for botulinum toxin).",
"risikenThirdrd":"Nerve injuries: an injury to the facial nerve in the lower facial area can lead to paralysis of the affected half of the face, as well as functional impairment of nerves (paresthesia, facial disorders). Most of them are temporary.",
"risikenForth":"Botulinum toxin preparations contain small amounts of human blood protein®. The risk of getting yourself through the administration of the",
"wizardRegisterFirstPageTitle":"Private practice Krstin Madri",
"wizardRegisterFirstPageUpperPartFirst":"Dear Patient,",
"wizardRegisterFirstPageUpperPartSeconde":"The protection of your data is important to us. Due to the treatment relationship with you, we are allowed to collect and process your data. In order to transfer your data in connection with your treatment to other service providers (e.g. other doctors, hospitals, laboratories) (e.g. by means of a doctor's letter) or to obtain it from other service providers, your consent is required at some points. Without this, we cannot adequately treat and inform the service providers. Otherwise we ask you to transmit the data to the service provider yourself or to obtain it from them. Your consent is also required for the information and exchange of your data to and with your relatives. We would like to point out that a rack connection to your clinical picture is possible on the basis of the documents mentioned.",
"wizardRegisterFirstPageCheckBoxTitle":"You can give us your consent below:",
"wizardRegisterPageCheckBox":"With my signature, I agree that my personal data (e.g. master data, insurance data and health data) may be exchanged with the following service providers for the purpose of continuous treatment and gapless documentation by Praxis Madri.",
"acceptanceConditionsMessage":"please accept the Terms and Conditions to continue",
"next":"Next",
...
"sampleInformatoinsheetForTreatment": "SAMPLE - INFORMATION SHEET FOR TREATMENT",
...
"howDoesLaserHairRemovalFeelLikeDescription": "Laser hair removal causes a slight sensation of warmth and can cause a slight stinging in the skin of sensitive skin. Skin cooling reduces these side effects considerably and increases comfort.",
"whenShouldLaserHairRemovalTreatmentBeAvoided": "When should laser hair removal treatment be avoided?",
"additionalInformationPractitioner": "Additional information on the treatment of the practitioner",
"safetyHistoryWhatYourPractitionerShouldKnow": "Safety history - what your practitioner should know:",
"areYouTakingAnyMdicationThatMakesYouMoreSensitiveToLight": "Are you taking medication that increases sensitivity to light?",
"areYouCurrentlyTakingAnyOtherMedication": " Are you currently taking any other medication?",
"areYouKnownToHaveAbnormalScarring": "Are you known to have abnormal scarring, e.g. after laser treatment?",
"areYouProneToHerpes": "Are You Prone To Herpes?",
"areYouProneToHyperOrHypopigmentation": "Are you prone to hyper- or hypopigmentation?",
"doYouHaveCardiovascularDisease": "Do you have a cardiovascular disease, e.g. Herziehler or high blood pressure?",
...
"sonstigesLaurenDeBatanderinDenBehenderZuAraaraer": "‘Other lauren de Batanderin / the agile to araâraer)",
"doesTheHealthInsuranceCompanyCoverTheCostsOfLaserHairRemovalTreatment": "Übernimmt die Krankenkasse die Kosten der Laserbehandlung zur Haarentfernung?",
"asARuleTheHealthInsuranceDoesNotCoverTheCostsForLaserHairRemovalThereAreExceptionalCases": "As a rule, the health insurance does not cover the costs for laser hair removal, but there are exceptional cases your practitioner will give you more detailed advice.",
"thisIsANonBindingSampleForPatient": "This is a non-binding sample for patient  customer education discussions. Alma Lasers GmbH assumes no liability for the correctness and \n completeness of the information. This document must be adapted by the practitioner to the conversation with the individual \n to be treated. This sample is not legally binding and does not replace an individual consultation between the practitioner and the person to be treated> \n Sample explanation laser hair removal Rev2 17_06_2019",
"clinicPractice": "Clinic / practice",
"patientNameAndAddress": "Patient name and address",
"dearPatient": "Dear Patient",
"thisInformationSheetIsUsedToPrepareForTheInformationInterview": "This information sheet is used to prepare for the information interview. Please read it carefully before the interview and fill out the questionnaire carefully.",
"liposuction": "Liposuction",
"liposuctionDescription": "With the surgical procedure of liposuction (liposuction), accumulations of fat under the skin can be permanently removed from almost any part of the body. However, liposuction is not a means of weight loss or a method of treating obesity. It is only used for fat distribution disorders and to correct problem areas that cannot be influenced by diet and exercise. Under certain conditions, liposuction is also possible on the face and neck. \n The doctor will note the places you will have liposuction on on the last page of this information sheet.",
"assumptionOfCosts": "Assumption of costs",
"asRuleTheHealthInsuranceCompanyDoesNotCoverTheCostsOfTheTreatment": "As a rule, the health insurance company does not cover the costs of the treatment and any complications that may require treatment. Therefore, the question of costs should be clarified in advance with your doctor / your health insurance company,",
"howIsTheProcedurePerformed": "How is the procedure performed?",
"dependingOnTheMethodAndExtentOfTheProcedure": "Depending on the method and extent of the procedure, liposuction is performed under local anesthesia (tumescent local anesthesia, usually in combination with the administration of a sedative) or under general anesthesia (general anesthesia). to be clarified separately.",
"theMethodsOfLiposuction": "The methods of liposuction",
"theMostCommonProcedureIsTheTumescentTechniqueCarriedOut": "Am häufigsten wird der Eingriff mit der Tumeszenztechnik durchgeführt, zu der wir auch in Ihrem Fall raten. Es handelt sich hierbei um die Verwendung von Medikamenten (z.B.Betäubungsmitteln) au&erhalb ihres Zulassungsbereichs (Off-Label-Use). Dies ist zulässig, sofern Sie der Verwendung nach eingehender Aufklärung zustimmen. Über mögliche Nebenwirkungen der dabei eingesetzten Medikamente wird Sie Ihr Arzt anhand des Beipackzettels informieren.\nUm die Fettzellen zunächst zu lockern und die Blutungsnei-\ngung zu verringern, wird bei dieser Technik vor der Fettabsaugung eine gröBere Menge Flüssigkeit (Kochsalzlösung)",
"footerForthDocPage": "Dokumentierte Patientenaufklärung » Herausgeber: Prof. K. Ulsenheimer (Medizinrecht) - Gründungshrsg.: Prof, W. Weißauer  \nFachgebietshrsg.: Prof. Dr. W. Gubisch - Autoren: Dr. M. Bromba, Prof. Dr. W, Gubisch - © 2019 by Thieme Compliance GmbH, 91058 \nErlangen - Vervielfältigungen jeglicher Art, auch Fotokopieren, verboten.\nBestell-Adresse: Thieme Compliance GmbH, Am Weichselgarten 30a, 91058 Erlangen, Tel, +49 (09131 93406-40, Bestell-Fax 93406-70 - www.thieme-compliance.de",
"footerForthDocPage2": " Red. 03/2019\nPDF 04/2019\nBestell-Nr. DEO16013",
"patientData": "Patient data",
"skinRejuvenationFacial": "Skin rejuvenation facial",
"skinRejuvenationOnTheNeckDecollete": "Skin rejuvenation on the neck / décolleté",
"wrinkleTreatmentPeripheralPeriodical": "Wrinkle treatment perioral / periorbital",
...
"dearPatientSecondeDescriptionDoc4": "You would like to have disruptive changes in the skin treated with the fractionated laser. It is your doctor's duty to tell you about the upcoming treatment. It discusses the method, risks, side effects and \n  errelment prospects of the laser treatment. Please read this information carefully and discuss any questions you may have with your doctor",
"fractionalLaserTreatment": "Fractional \n laser treatment",
"fractionalLaserTreatmentBtn": "Fractional  laser treatment",
"fractionalLaserTreatmentOneLine": "How does fractional laser treatment work?",
"howDoesFractionalLaserTreatmentWork": "How does fractional laser treatment work?",
...
"howIsFractionalLaserTreatmentPerformed": "How is fractional laser treatment performed?",
...
"howDoesFractionalLaserTreatmentFeel": "How does fractional laser treatment feel?",
"howDoesFractionalLaserTreatmentFeelDescription": "Fractional laser treatment can cause a slight burning or stinging sensation in the skin. Some patients describe this feeling as being like clicking a rubber band on the skin. The skin cooling and, if necessary, a local anesthetic, e.g. with a cream, reduce these unpleasant side effects and increase your comfort during the treatment. After the treatment, the skin may feel like a light sunburn for a few hours.",
"whenShouldFractionalLaserTreatmentBeAvoided": "When should fractional laser treatment be avoided?",
...
"safetyHistoryWhatYourDoctorShouldKnow": "Safety History - What Your Doctor Should Know:",
"areYouTakingMedicationThatIncreasesTheSensitivityToLight": "Are you taking medication that increases the sensitivity to light?",
"doYouHaveAnyKnownHypersensitivityToLocalAnesthetics": "Do you have any known hypersensitivity to local anesthetics?",
"areYouAnalForHerpes":"Are You Anal For Herpes?",
"areYouProneToScarringOrLoosing": "Are you prone to scarring or loosing?",
"ifYouHaveACardiovascularDiseaseHeartDefectOrHighBloodPressure": "If you have a cardiovascular disease. e.g. heart defect or high blood pressure?",
"areYouPregnantOrAreYouInThreesome": "Are you pregnant or are you in threesome?",
"doesTheHealthInsuranceCompanyCoverTheCostsOfLaserHairRemovalTreatmentDoc3": "Does the health insurance company cover the costs of laser hair removal treatment?",
"doesTheHealthInsuranceCompanyCoverTheCostsOfLaserHairRemovalTreatmentDoc3Descritpion": "As a rule, the health insurance does not cover the costs of laser hair removal, but there are exceptions, all \n your practitioner will give you more detailed advice on this.",
"details":"Details",
...
"text": "Text",
"calender": "Calendar",
"balanceShouldBeMoreOrEequalThanLastBalance": "balance should be more or equal  than last balance",
"balanceShouldBeSmallerOrEqualThanCost": "balance should be smaller or equal  than cost ",
...
"phoneValidationMessage": "start with either 0 or 00 and then a numbers between 8 and 15",
"gender": "Gender",
...
"cannotCreateAppointmentinOutWork": "can not use  Out Work Time 08:00 to 22:00",
...
"overview": "Overview",
"payment": "payment",
"medicineNumbersMessagePrescription": "only 7 medicine can be added to one  prescription",
"pleaseChooseDoctor": "please choose Doctor",
"patientNameFirstLast": "patient first and last name must be separated by space",
...
"weExperiencedAnErrorLoggingYouInWouldYouPlease": "We Experienced an Error Logging You in, would you please log in again?",
...
"youShouldLeaveACancellationReason": "You should choose a cancellation reason",
